...
📊 Social Media & Student Well‑Being Dashboard

🌐 Overview

This project explores how student social media usage correlates with sleep patterns, academic performance, mental health, and relationship dynamics. Built in Power BI, the dashboard demonstrates end‑to‑end data modeling, transformation, and interactive storytelling.
...
- Data Preparation
   . Created calculated columns (Health Band, Conflict Level)
   . Built measures for averages, percentages, and counts (Avg Sleep Hours, % Affected Academically)
- Time Intelligence
...
- Report Pages
   ...
   . 🔍 Drill‑Through Student Profile: demographics, sleep, usage, conflicts, mental health
- Interactivity
